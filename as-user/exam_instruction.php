					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									<input class="input" placeholder="Search for Courses">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Benchmark academy</h2>
							<p>AIM ABOVE THE MARK</p>
							<a class="primary-btn cta-btn" href="../">Discover now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
...
<?php
		...
		while($row = $result->fetch_assoc()) {
			...
			$_SESSION['total_question'] = $row['total_questions'];
